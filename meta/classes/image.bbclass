...
IMAGE_FEATURES[validitems] += "debug-tweaks read-only-rootfs empty-root-password"
...
ROOTFS_POSTPROCESS_COMMAND += '${@bb.utils.contains("IMAGE_FEATURES", "empty-root-password", "ssh_allow_empty_password; ", "",d)}'
